# Placeholder build module for dynamic_graphql.
#
...
# implementation when dynamic_graphql.build is ready to produce build artefacts.
...
def build(*_args: Any, **_kwargs: Any) -> Mapping[str, Any]:
    """Construct build artefacts for dynamic_graphql.

    Replace this stub with logic that returns serialisable data required by
    the Dynamic CLI.
    """
    raise NotImplementedError(
        "dynamic_graphql.build is not implemented yet."
    )


def main() -> int:
    """Entry point for "python -m dynamic_graphql.build"."""
    message = (
        "dynamic_graphql.build is a placeholder module.\n"
