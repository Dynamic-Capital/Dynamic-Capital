...
export const TON_MAINNET_PRIMARY_MULTISIG_BOUNCEABLE =
  "EQD1zAJPYZMYf3Y9B4SL7fRLFU-Vg5V7RcLMnEu2H_cNOPDD";

export const TON_MAINNET_PRIMARY_MULTISIG_NON_BOUNCEABLE =
  TON_MAINNET_PRIMARY_MULTISIG;

export const TON_MAINNET_OPERATIONS_TREASURY =
  TON_MAINNET_PRIMARY_MULTISIG;

export const TON_MAINNET_OPERATIONS_TREASURY_NON_BOUNCEABLE =
  TON_MAINNET_PRIMARY_MULTISIG_NON_BOUNCEABLE;

export const TON_MAINNET_DAO_MULTISIG = TON_MAINNET_PRIMARY_MULTISIG;
...
export const TON_MAINNET_DAO_MULTISIG_EXPLORER_URL =
  `https://tonviewer.com/${TON_MAINNET_PRIMARY_MULTISIG_BOUNCEABLE}`;
...
export const TON_MAINNET_ACCOUNT_DEFINITIONS = [
  {
    ...
    nonBounceableAddress: TON_MAINNET_OPERATIONS_TREASURY_NON_BOUNCEABLE,
    description:
