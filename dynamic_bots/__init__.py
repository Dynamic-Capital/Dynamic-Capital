...
_EXPORT_MAP = {
    ...
    "dynamic_bots.astronomy": ("DynamicAstronomyBot",),
    "dynamic_bots.atom": ("DynamicAtomBot",),
    "dynamic_bots.business": ("DynamicBusinessBot",),
    "dynamic_bots.cislunar": ("DynamicCislunarBot",),
    "dynamic_bots.cosmic": ("DynamicCosmicBot",),
    "dynamic_bots.dhivehi_language": ("DynamicDhivehiLanguageBot",),
    "dynamic_bots.dimensions": ("DynamicDimensionBot",),
    ...
    "dynamic_bots.energy": ("DynamicEnergyBot",),
    "dynamic_bots.intergalactic": ("DynamicIntergalacticBot",),
    "dynamic_bots.interplanetary": ("DynamicInterplanetaryBot",),
    "dynamic_bots.interstellar": ("DynamicInterstellarBot",),
    ...
    "dynamic_bots.wave": ("DynamicWaveBot",),
    "dynamic_crawl": (
        "CrawlPlan",
        "DynamicCrawler",
        "FetchPayload",
