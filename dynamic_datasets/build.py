# Placeholder build module for dynamic_datasets.
#
...
# implementation when dynamic_datasets.build is ready to produce build artefacts.
...
def build(*_args: Any, **_kwargs: Any) -> Mapping[str, Any]:
    """Construct build artefacts for dynamic_datasets.

    Replace this stub with logic that returns serialisable data required by
    the Dynamic CLI.
    """
    raise NotImplementedError(
        "dynamic_datasets.build is not implemented yet."
    )


def main() -> int:
    """Entry point for "python -m dynamic_datasets.build"."""
    message = (
        "dynamic_datasets.build is a placeholder module.\n"
