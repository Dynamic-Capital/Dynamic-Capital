...
| -------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------- | ---------------------------------------------------------------------------------------------- |
| `operations_wallet` (`dct_app_config`) | TON wallet receiving the operations split calculated by [`dct-auto-invest`](../supabase/functions/dct-auto-invest/index.ts).      | `UQD1zAJPYZMYf3Y9B4SL7fRLFU-Vg5V7RcLMnEu2H_cNOK0G` | Rotate via Supabase SQL `update` and broadcast the new resolver through the multisig timelock. |
| `dct_jetton_master` (`dct_app_config`) | Jetton master contract referenced by [`dct-auto-invest`](../supabase/functions/dct-auto-invest/index.ts) for burns and emissions. | `UQD1zAJPYZMYf3Y9B4SL7fRLFU-Vg5V7RcLMnEu2H_cNOK0G` | When redeploying, update the DNS resolver and regenerate the Mini App manifest before release. |
