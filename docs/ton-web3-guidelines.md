...
| `dct_jetton_master` (`dct_app_config`) | Jetton master contract referenced by [`dct-auto-invest`](../supabase/functions/dct-auto-invest/index.ts) for burns and emissions. | `EQAHMNCDJmEK8yEt1IbaJP1xl2-wd21f1Gpt_57Z1uCPP2d9` | When redeploying, update the DNS resolver and regenerate the Mini App manifest before release. |
