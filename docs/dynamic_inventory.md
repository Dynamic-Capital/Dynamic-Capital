...
This reference enumerates top-level directories in the repository that begin
with the `dynamic_` prefix. Use it as a quick inventory when exploring the
experimental modules that complement the core Dynamic Capital application.
...
For more comprehensive repository context, review
[`docs/REPO_INVENTORY.md`](./REPO_INVENTORY.md), which links each major surface
to its corresponding documentation and code references.
