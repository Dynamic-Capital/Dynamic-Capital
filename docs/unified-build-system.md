...
3. **DigitalOcean**: `https://dynamic-capital-qazf2.ondigitalocean.app` (serves
   the bundled static landing page after the 2025-10-11 redeploy)
4. **DigitalOcean Origin**:
   `https://dynamic-capital-qazf2.ondigitalocean.app/dynamiccapital.ton`,
   `https://ton-gateway.dynamic-capital.lovable.app/dynamiccapital.ton` (both
   hosts returned HTTP 200 during the 2025-10-11 post-deploy verification)
