...
This optimized glossary centralizes key Dynamic Capital terminology and calls out the
letter each term starts with, the words that matter most, and any governing
numbers for quick recall while building, operating, or auditing the platform.
...
- Pair this glossary with the
  ...
  vocabulary and consult the
  [Dynamic AI Overview](./dynamic-ai-overview.md) or
