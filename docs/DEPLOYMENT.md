...
DigitalOcean provisions the `dynamic-capital.ondigitalocean.app` domain. Its
exported zone file lives in
...
the Dynamic domain aligned with the expected records:
