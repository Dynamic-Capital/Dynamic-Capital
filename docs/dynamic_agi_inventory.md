...
`dynamic_agi` package. Use it to understand how evaluation, self-improvement,
...
for the full AGI toolchain.【F:dynamic_agi/**init**.py†L1-L29】
...
- **Identity & version metadata** – `DynamicAGIIdentity` preserves the canonical
  ...
  auditing.【F:dynamic_agi/model.py†L33-L73】【F:dynamic_agi/model.py†L143-L158】【F:dynamic_agi/model.py†L200-L218】
- **Structured outputs** – `AGIOutput` packages the trading signal, research
  ...
  timestamps.【F:dynamic_agi/model.py†L161-L197】
- **Diagnostics payload** – `AGIDiagnostics` captures the contextual snapshot
  ...
  provenance.【F:dynamic_agi/model.py†L128-L142】【F:dynamic_agi/model.py†L328-L337】
- **Evaluation pipeline** – `DynamicAGIModel.evaluate` prepares the market
  ...
  and optional self-improvement feedback.【F:dynamic_agi/model.py†L232-L326】
- **Inventory-aware market making** – The orchestrator passes current inventory
  ...
  aggressiveness.【F:dynamic_agi/model.py†L309-L325】【F:dynamic_ai/core.py†L652-L679】
- **Llama reasoning adapter** – By default the orchestrator provisions an
  ...
  the cache
  size.【F:dynamic_agi/model.py†L142-L165】【F:dynamic_agi/model.py†L238-L275】【F:dynamic_ai/core.py†L165-L180】【F:dynamic_ai/core.py†L600-L628】
...
- **Telemetry primitives** – `ImprovementSignal` normalises directional feedback
  ...
  timestamps.【F:dynamic_agi/self_improvement.py†L14-L155】
- **Blueprint-driven planning** – `ImprovementPlan` aggregates focus metrics,
  ...
  history.【F:dynamic_agi/self_improvement.py†L313-L353】【F:dynamic_agi/self_improvement.py†L430-L467】
- **Adaptive record keeper** – `DynamicSelfImprovement` records each session,
  ...
  construction.【F:dynamic_agi/self_improvement.py†L356-L520】【F:dynamic_agi/self_improvement.py†L497-L640】
...
- **Example and batch wrappers** – `FineTuneExample` and `FineTuneBatch` wrap
  ...
  reproducible.【F:dynamic_agi/fine_tune.py†L14-L162】
- **Rolling dataset management** – `DynamicFineTuneDataset` enforces capacity
  ...
  auditability.【F:dynamic_agi/fine_tune.py†L164-L231】
- **Telemetry-to-dataset bridge** – `DynamicAGIFineTuner` converts
  ...
  downstream fine-tuning jobs.【F:dynamic_agi/fine_tune.py†L233-L285】
...
- **Task configuration** – `AGILocalMachineTaskConfig` supplies default command
  ...
  plans into automation tasks.【F:dynamic_agi/local_machine.py†L52-L117】
- **Plan materialisers** – `build_local_machine_plan_from_improvement` and
  ...
  pipelines.【F:dynamic_agi/local_machine.py†L119-L188】
