...
Repeat this process until all the paths are migrated to Vercel and all rewrites
are removed.
...
Repeat steps 1 and 2 until all the features have been migrated to Vercel. You
