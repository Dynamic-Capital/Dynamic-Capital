...
| `dao_contract`         | `EQDSmz4RrDBFG-T1izwVJ7q1dpAq1mJTLrKwyMYJig6Wx_6y`                                                                                        | Interim DAO governance multisig (mirrors the operations treasury until a dedicated DAO wallet is deployed)                                   |
