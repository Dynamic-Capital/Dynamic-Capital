...
| `dao_contract`         | `EQD1zAJPYZMYf3Y9B4SL7fRLFU-Vg5V7RcLMnEu2H_cNOPDD`                                                                                        | Interim DAO governance multisig (mirrors the operations treasury until a dedicated DAO wallet is deployed)                                   |
