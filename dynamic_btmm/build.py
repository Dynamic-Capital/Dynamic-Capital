# Placeholder build module for dynamic_btmm.
#
...
# implementation when dynamic_btmm.build is ready to produce build artefacts.
...
def build(*_args: Any, **_kwargs: Any) -> Mapping[str, Any]:
    """Construct build artefacts for dynamic_btmm.

    Replace this stub with logic that returns serialisable data required by
    the Dynamic CLI.
    """
    raise NotImplementedError(
        "dynamic_btmm.build is not implemented yet."
    )


def main() -> int:
    """Entry point for "python -m dynamic_btmm.build"."""
    message = (
        "dynamic_btmm.build is a placeholder module.\n"
