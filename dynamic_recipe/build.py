# Placeholder build module for dynamic_recipe.
#
...
# implementation when dynamic_recipe.build is ready to produce build artefacts.
...
def build(*_args: Any, **_kwargs: Any) -> Mapping[str, Any]:
    """Construct build artefacts for dynamic_recipe.

    Replace this stub with logic that returns serialisable data required by
    the Dynamic CLI.
    """
    raise NotImplementedError(
        "dynamic_recipe.build is not implemented yet."
    )
...
def main() -> int:
    ...
    message = (
        "dynamic_recipe.build is a placeholder module.\n"
