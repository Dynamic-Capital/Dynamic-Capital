# Placeholder build module for dynamic_grammar.
#
...
# implementation when dynamic_grammar.build is ready to produce build artefacts.
...
def build(*_args: Any, **_kwargs: Any) -> Mapping[str, Any]:
    """Construct build artefacts for dynamic_grammar.

    Replace this stub with logic that returns serialisable data required by
    the Dynamic CLI.
    """
    raise NotImplementedError(
        "dynamic_grammar.build is not implemented yet."
    )


def main() -> int:
    """Entry point for "python -m dynamic_grammar.build"."""
    message = (
        "dynamic_grammar.build is a placeholder module.\n"
