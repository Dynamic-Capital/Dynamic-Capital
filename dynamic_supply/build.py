# Placeholder build module for dynamic_supply.
#
...
# implementation when dynamic_supply.build is ready to produce build artefacts.
...
def build(*_args: Any, **_kwargs: Any) -> Mapping[str, Any]:
    """Construct build artefacts for dynamic_supply.

    Replace this stub with logic that returns serialisable data required by
    the Dynamic CLI.
    """
    raise NotImplementedError(
        "dynamic_supply.build is not implemented yet."
    )


def main() -> int:
    """Entry point for "python -m dynamic_supply.build"."""
    message = (
        "dynamic_supply.build is a placeholder module.\n"
