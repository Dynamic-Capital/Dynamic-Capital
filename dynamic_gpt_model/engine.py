...
_METADATA_SEPARATOR_TRANSLATION = str.maketrans({
    " ": ".",
    "-": ".",
    "_": ".",
    "/": ".",
...
def _normalise_metadata_key(key: str) -> str:
    """Return a canonical representation for metadata keys."""

    cleaned = key.strip().lower()
    cleaned = cleaned.replace("::", ".").replace(":", ".")
    cleaned = cleaned.translate(_METADATA_SEPARATOR_TRANSLATION)
