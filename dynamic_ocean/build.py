# Placeholder build module for dynamic_ocean.
#
...
# implementation when dynamic_ocean.build is ready to produce build artefacts.
...
def build(*_args: Any, **_kwargs: Any) -> Mapping[str, Any]:
    """Construct build artefacts for dynamic_ocean.

    Replace this stub with logic that returns serialisable data required by
    the Dynamic CLI.
    """
    raise NotImplementedError(
        "dynamic_ocean.build is not implemented yet."
    )


def main() -> int:
    """Entry point for "python -m dynamic_ocean.build"."""
    message = (
        "dynamic_ocean.build is a placeholder module.\n"
