...
- **Dynamic experiment catalog** – The experimental `dynamic_*` workspaces in
  ...
  [`docs/dynamic_inventory.md`](docs/dynamic_inventory.md). Run
  `npm run docs:dynamic-inventory` after adding or archiving a module so the
  documentation stays in sync with the on-disk layout.
