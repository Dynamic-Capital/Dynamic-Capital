...
> <https://ton-gateway.dynamic-capital.ondigitalocean.app/dynamiccapital.ton> or install a TON-enabled wallet
...
- **Supported wallets** include Wallet (Telegram), Tonkeeper, DeDust Wallet,
  STON.fi Wallet, MyTonWallet, Tonhub, and OpenMask with
