# Placeholder build module for dynamic_version.
#
...
# implementation when dynamic_version.build is ready to produce build artefacts.
...
def build(*_args: Any, **_kwargs: Any) -> Mapping[str, Any]:
    """Construct build artefacts for dynamic_version.

    Replace this stub with logic that returns serialisable data required by
    the Dynamic CLI.
    """
    raise NotImplementedError(
        "dynamic_version.build is not implemented yet."
    )


def main() -> int:
    """Entry point for "python -m dynamic_version.build"."""
    message = (
        "dynamic_version.build is a placeholder module.\n"
