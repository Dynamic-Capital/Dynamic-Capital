# Placeholder build module for dynamic_supabase.
#
...
# implementation when dynamic_supabase.build is ready to produce build artefacts.
...
def build(*_args: Any, **_kwargs: Any) -> Mapping[str, Any]:
    """Construct build artefacts for dynamic_supabase.

    Replace this stub with logic that returns serialisable data required by
    the Dynamic CLI.
    """
    raise NotImplementedError(
        "dynamic_supabase.build is not implemented yet."
    )


def main() -> int:
    """Entry point for "python -m dynamic_supabase.build"."""
    message = (
        "dynamic_supabase.build is a placeholder module.\n"
