# Placeholder build module for dynamic_crawlers.
#
...
# implementation when dynamic_crawlers.build is ready to produce build artefacts.
...
def build(*_args: Any, **_kwargs: Any) -> Mapping[str, Any]:
    """Construct build artefacts for dynamic_crawlers.

    Replace this stub with logic that returns serialisable data required by
    the Dynamic CLI.
    """
    raise NotImplementedError(
        "dynamic_crawlers.build is not implemented yet."
    )


def main() -> int:
    """Entry point for "python -m dynamic_crawlers.build"."""
    message = (
        "dynamic_crawlers.build is a placeholder module.\n"
