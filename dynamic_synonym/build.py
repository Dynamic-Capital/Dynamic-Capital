# Placeholder build module for dynamic_synonym.
#
...
# implementation when dynamic_synonym.build is ready to produce build artefacts.
...
def build(*_args: Any, **_kwargs: Any) -> Mapping[str, Any]:
    """Construct build artefacts for dynamic_synonym.

    Replace this stub with logic that returns serialisable data required by
    the Dynamic CLI.
    """
    raise NotImplementedError(
        "dynamic_synonym.build is not implemented yet."
    )


def main() -> int:
    """Entry point for "python -m dynamic_synonym.build"."""
    message = (
        "dynamic_synonym.build is a placeholder module.\n"
