# Placeholder build module for dynamic_package.
#
...
# implementation when dynamic_package.build is ready to produce build artefacts.
...
def build(*_args: Any, **_kwargs: Any) -> Mapping[str, Any]:
    """Construct build artefacts for dynamic_package.

    Replace this stub with logic that returns serialisable data required by
    the Dynamic CLI.
    """
    raise NotImplementedError(
        "dynamic_package.build is not implemented yet."
    )


def main() -> int:
    """Entry point for "python -m dynamic_package.build"."""
    message = (
        "dynamic_package.build is a placeholder module.\n"
