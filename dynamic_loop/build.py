# Placeholder build module for dynamic_loop.
#
...
# implementation when dynamic_loop.build is ready to produce build artefacts.
...
def build(*_args: Any, **_kwargs: Any) -> Mapping[str, Any]:
    """Construct build artefacts for dynamic_loop.

    Replace this stub with logic that returns serialisable data required by
    the Dynamic CLI.
    """
    raise NotImplementedError(
        "dynamic_loop.build is not implemented yet."
    )


def main() -> int:
    """Entry point for "python -m dynamic_loop.build"."""
    message = (
        "dynamic_loop.build is a placeholder module.\n"
