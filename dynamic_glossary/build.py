# Placeholder build module for dynamic_glossary.
#
...
# implementation when dynamic_glossary.build is ready to produce build artefacts.
...
def build(*_args: Any, **_kwargs: Any) -> Mapping[str, Any]:
    """Construct build artefacts for dynamic_glossary.

    Replace this stub with logic that returns serialisable data required by
    the Dynamic CLI.
    """
    raise NotImplementedError(
        "dynamic_glossary.build is not implemented yet."
    )
...
def main() -> int:
    ...
    message = (
        "dynamic_glossary.build is a placeholder module.\n"
