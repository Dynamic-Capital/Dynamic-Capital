# Placeholder build module for dynamic_routine.
#
...
# implementation when dynamic_routine.build is ready to produce build artefacts.
...
def build(*_args: Any, **_kwargs: Any) -> Mapping[str, Any]:
    """Construct build artefacts for dynamic_routine.

    Replace this stub with logic that returns serialisable data required by
    the Dynamic CLI.
    """
    raise NotImplementedError(
        "dynamic_routine.build is not implemented yet."
    )


def main() -> int:
    """Entry point for "python -m dynamic_routine.build"."""
    message = (
        "dynamic_routine.build is a placeholder module.\n"
