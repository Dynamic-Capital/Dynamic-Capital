# Placeholder build module for dynamic_metadata.
#
...
# implementation when dynamic_metadata.build is ready to produce build artefacts.
...
def build(*_args: Any, **_kwargs: Any) -> Mapping[str, Any]:
    """Construct build artefacts for dynamic_metadata.

    Replace this stub with logic that returns serialisable data required by
    the Dynamic CLI.
    """
    raise NotImplementedError(
        "dynamic_metadata.build is not implemented yet."
    )


def main() -> int:
    """Entry point for "python -m dynamic_metadata.build"."""
    message = (
        "dynamic_metadata.build is a placeholder module.\n"
