define(["exports"], function (t) {
    ...
    async q(t, e, n) {
      ...
      try {
        ...
        if (s instanceof Error) {
          for (
            const i of t.iterateCallbacks("handlerDidError")
  ...
  function j(t, e) {
    ...
    if (
      !(s in (n ? IDBIndex : IDBObjectStore).prototype) || !r && !P.includes(s)
    ) return;
