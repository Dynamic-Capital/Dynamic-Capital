# Placeholder build module for dynamic_ton.
#
...
# implementation when dynamic_ton.build is ready to produce build artefacts.
...
def build(*_args: Any, **_kwargs: Any) -> Mapping[str, Any]:
    """Construct build artefacts for dynamic_ton.

    Replace this stub with logic that returns serialisable data required by
    the Dynamic CLI.
    """
    raise NotImplementedError(
        "dynamic_ton.build is not implemented yet."
    )


def main() -> int:
    """Entry point for "python -m dynamic_ton.build"."""
    message = (
        "dynamic_ton.build is a placeholder module.\n"
