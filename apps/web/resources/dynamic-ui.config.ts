...
const routes: RoutesConfig = {
  "/": { enabled: true, includeChildren: true },
  "/about": { enabled: true, includeChildren: true },
  "/admin": { enabled: true, includeChildren: true },
  "/blog": { enabled: true, includeChildren: true },
  "/checkout": { enabled: true, includeChildren: true },
  "/payment-status": { enabled: true, includeChildren: true },
  "/gallery": { enabled: true, includeChildren: true },
  "/investor": { enabled: true, includeChildren: true },
  "/login": { enabled: true, includeChildren: true },
  "/miniapp": { enabled: true, includeChildren: true },
  "/plans": { enabled: true, includeChildren: true },
  "/profile": { enabled: true, includeChildren: true },
  "/school": { enabled: true, includeChildren: true },
  "/support": { enabled: true, includeChildren: true },
  "/wallet": { enabled: true, includeChildren: true },
  "/tools": { enabled: true, includeChildren: true },
  "/styles": { enabled: true, includeChildren: true },
  "/telegram": { enabled: true, includeChildren: true },
  "/token": { enabled: true, includeChildren: true },
  "/ui/sandbox": { enabled: true, includeChildren: true },
