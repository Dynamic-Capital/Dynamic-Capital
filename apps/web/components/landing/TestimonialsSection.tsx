      ...
      testimonials: [
        {
          ...
          avatar: "💼",
          text:
            `${brand.identity.name}'s signals increased my portfolio by 340% in 6 months. The accuracy is incredible!`,
          profit: "+$45,000",
        },
        {
          name: "James L.",
        ...
        },
        {
          ...
          avatar: "🎯",
          text:
            `From losing money to consistent profits. ${brand.identity.name} changed my trading game completely!`,
          profit: "+$32,000",
        },
      ],
    }),
