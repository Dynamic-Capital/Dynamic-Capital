...
export const InteractiveBackground: React.FC<InteractiveBackgroundProps> = ({
  ...
  return (
    <div className={backgroundClasses}>
      ...
      <div className="absolute top-0 right-0 w-72 h-72 bg-gradient-to-br from-primary/50 to-accent/50 rounded-full mix-blend-multiply filter blur-xl opacity-10 animate-float" style={{ animationDelay: '2s' }} />
      <div className="absolute bottom-0 left-1/2 w-72 h-72 bg-gradient-to-br from-blue-400 to-green-400 rounded-full mix-blend-multiply filter blur-xl opacity-10 animate-float" style={{ animationDelay: '4s' }} />
    </div>
  );
};
