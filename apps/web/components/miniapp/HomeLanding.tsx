        ...
        if (
          ...
          setAboutUs(
            aboutContent?.content_value ||
              `${brand.identity.name} is your premier destination for professional trading insights and VIP market analysis. We provide cutting-edge trading signals, comprehensive market research, and personalized support to help you achieve your financial goals.`,
          );
          setServices(
      ...
      >
        ...
        >
          <CardContent className="p-6 text-center">
            ...
            <p className="text-body-sm text-muted-foreground mb-4">
              Join thousands of successful traders who trust{" "}
              {brand.identity.name} for their trading journey.
            </p>
