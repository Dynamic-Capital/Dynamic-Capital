...
const DEFAULT_PLAYBOOK_URL = "https://api.dynamiccapital.ton/ags/playbook";
...
export const DYNAMIC_AGS_PLAYBOOK_URL = resolveUrl(
  "DYNAMIC_AGS_PLAYBOOK_URL",
  getEnvVar("DYNAMIC_AGS_PLAYBOOK_URL"),
