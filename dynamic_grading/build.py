# Placeholder build module for dynamic_grading.
#
...
# implementation when dynamic_grading.build is ready to produce build artefacts.
...
def build(*_args: Any, **_kwargs: Any) -> Mapping[str, Any]:
    """Construct build artefacts for dynamic_grading.

    Replace this stub with logic that returns serialisable data required by
    the Dynamic CLI.
    """
    raise NotImplementedError(
        "dynamic_grading.build is not implemented yet."
    )


def main() -> int:
    """Entry point for "python -m dynamic_grading.build"."""
    message = (
        "dynamic_grading.build is a placeholder module.\n"
