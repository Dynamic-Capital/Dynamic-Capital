# Placeholder build module for dynamic_zone.
#
...
# implementation when dynamic_zone.build is ready to produce build artefacts.
...
def build(*_args: Any, **_kwargs: Any) -> Mapping[str, Any]:
    """Construct build artefacts for dynamic_zone.

    Replace this stub with logic that returns serialisable data required by
    the Dynamic CLI.
    """
    raise NotImplementedError(
        "dynamic_zone.build is not implemented yet."
    )


def main() -> int:
    """Entry point for "python -m dynamic_zone.build"."""
    message = (
        "dynamic_zone.build is a placeholder module.\n"
