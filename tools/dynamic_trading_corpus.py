"""Generate a page-level corpus from the dynamic trading knowledge PDFs."""
...
DEFAULT_PDF_DIR = Path("data/knowledge_base/dynamic_trading/raw")
DEFAULT_OUTPUT_DIR = Path("data/knowledge_base/dynamic_trading/extracted")
DEFAULT_JSONL_PATH = Path("data/knowledge_base/dynamic_trading/processed/dynamic_trading_knowledge.jsonl")
DEFAULT_SUMMARY_PATH = Path("data/knowledge_base/dynamic_trading/processed/dynamic_trading_summary.json")
...
def generate_dynamic_trading_corpus(
    ...
    *,
    ...
    """Run the PDF extractor and materialise a JSONL corpus for retrieval."""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--pdf-dir", type=Path, default=DEFAULT_PDF_DIR, help="Directory containing the mirrored PDFs.")
    parser.add_argument(
        "--output-dir",
        type=Path,
...
def main(argv: Iterable[str] | None = None) -> int:
    ...
    try:
        summary = generate_dynamic_trading_corpus(
            args.pdf_dir,
