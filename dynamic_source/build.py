# Placeholder build module for dynamic_source.
#
...
# implementation when dynamic_source.build is ready to produce build artefacts.
...
def build(*_args: Any, **_kwargs: Any) -> Mapping[str, Any]:
    """Construct build artefacts for dynamic_source.

    Replace this stub with logic that returns serialisable data required by
    the Dynamic CLI.
    """
    raise NotImplementedError(
        "dynamic_source.build is not implemented yet."
    )


def main() -> int:
    """Entry point for "python -m dynamic_source.build"."""
    message = (
        "dynamic_source.build is a placeholder module.\n"
