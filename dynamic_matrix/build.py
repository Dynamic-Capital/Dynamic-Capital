# Placeholder build module for dynamic_matrix.
#
...
# implementation when dynamic_matrix.build is ready to produce build artefacts.
...
def build(*_args: Any, **_kwargs: Any) -> Mapping[str, Any]:
    """Construct build artefacts for dynamic_matrix.

    Replace this stub with logic that returns serialisable data required by
    the Dynamic CLI.
    """
    raise NotImplementedError(
        "dynamic_matrix.build is not implemented yet."
    )


def main() -> int:
    """Entry point for "python -m dynamic_matrix.build"."""
    message = (
        "dynamic_matrix.build is a placeholder module.\n"
