...
_LAZY = LazyNamespace(
    ...
    overrides={
        ...
        "DynamicSecurityAgent": "dynamic_agents.security",
        "SecurityAgentInsight": "dynamic_agents.security",
        ...
        "BusinessEngineInsight": "dynamic_agents.business",
        "SalesSnapshot": "dynamic_agents.business",
        "AccountingSnapshot": "dynamic_agents.business",
        "MarketingSnapshot": "dynamic_agents.business",
        "PsychologySnapshot": "dynamic_agents.business",
        "QuantumAgentProfile": "dynamic_agents.quantum",
        "QuantumAgentInsight": "dynamic_agents.quantum",
        "DynamicQuantumAgent": "dynamic_agents.quantum",
        "run_all_quantum_agents": "dynamic_agents.quantum",
        "list_quantum_agent_profiles": "dynamic_agents.quantum",
        "build_quantum_agent_registry": "dynamic_agents.quantum",
        "DynamicZeusQuantumAgent": "dynamic_agents.quantum",
        "DynamicHeraQuantumAgent": "dynamic_agents.quantum",
        "DynamicPoseidonQuantumAgent": "dynamic_agents.quantum",
        "DynamicDemeterQuantumAgent": "dynamic_agents.quantum",
        "DynamicAthenaQuantumAgent": "dynamic_agents.quantum",
        "DynamicApolloQuantumAgent": "dynamic_agents.quantum",
        "DynamicArtemisQuantumAgent": "dynamic_agents.quantum",
        "DynamicAresQuantumAgent": "dynamic_agents.quantum",
        "DynamicAphroditeQuantumAgent": "dynamic_agents.quantum",
        "DynamicHephaestusQuantumAgent": "dynamic_agents.quantum",
        "DynamicHermesQuantumAgent": "dynamic_agents.quantum",
        "DynamicDionysusQuantumAgent": "dynamic_agents.quantum",
