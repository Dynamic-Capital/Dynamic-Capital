# Placeholder build module for dynamic_crawl.
#
...
# implementation when dynamic_crawl.build is ready to produce build artefacts.
...
def build(*_args: Any, **_kwargs: Any) -> Mapping[str, Any]:
    """Construct build artefacts for dynamic_crawl.

    Replace this stub with logic that returns serialisable data required by
    the Dynamic CLI.
    """
    raise NotImplementedError(
        "dynamic_crawl.build is not implemented yet."
    )
...
def main() -> int:
    ...
    message = (
        "dynamic_crawl.build is a placeholder module.\n"
