...
export const InteractiveBackground: React.FC<InteractiveBackgroundProps> = ({
  ...
  return (
    <div className={backgroundClasses}>
      ...
      <div className="absolute top-0 right-0 w-72 h-72 bg-gradient-to-br from-purple-400 to-pink-400 rounded-full mix-blend-multiply filter blur-xl opacity-10 animate-float" style={{ animationDelay: '2s' }} />
