...
export const BrandCard: React.FC<BrandCardProps> = ({
  ...
  const cardClasses = cn(
    'transition-all duration-300',
    {
      ...
      'bg-gradient-brand text-white border-none shadow-xl shadow-primary/20': variant === 'brand',
      
      // Glass morphism effect
      'bg-white/10 backdrop-blur-md border border-white/20 text-foreground shadow-lg': variant === 'glass',
      
      // Elevated card with enhanced shadow
      'bg-card text-card-foreground border-none shadow-2xl shadow-primary/10': variant === 'elevated',
