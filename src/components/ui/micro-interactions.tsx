...
export function MicroButton({ 
  ...
  const variantClasses = {
    ...
    glow: "bg-primary hover:bg-primary/90 text-primary-foreground shadow-[0_0_20px_hsl(var(--primary)/0.5)]",
    magnetic: "bg-primary/10 hover:bg-primary/20 text-primary border border-primary/30"
  };
