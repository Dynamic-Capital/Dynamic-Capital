# Placeholder build module for dynamic_cosmic.
#
...
# implementation when dynamic_cosmic.build is ready to produce build artefacts.
...
def build(*_args: Any, **_kwargs: Any) -> Mapping[str, Any]:
    """Construct build artefacts for dynamic_cosmic.

    Replace this stub with logic that returns serialisable data required by
    the Dynamic CLI.
    """
    raise NotImplementedError(
        "dynamic_cosmic.build is not implemented yet."
    )


def main() -> int:
    """Entry point for "python -m dynamic_cosmic.build"."""
    message = (
        "dynamic_cosmic.build is a placeholder module.\n"
