# Placeholder build module for dynamic_arrow.
#
...
# implementation when dynamic_arrow.build is ready to produce build artefacts.
...
def build(*_args: Any, **_kwargs: Any) -> Mapping[str, Any]:
    """Construct build artefacts for dynamic_arrow.

    Replace this stub with logic that returns serialisable data required by
    the Dynamic CLI.
    """
    raise NotImplementedError(
        "dynamic_arrow.build is not implemented yet."
    )


def main() -> int:
    """Entry point for "python -m dynamic_arrow.build"."""
    message = (
        "dynamic_arrow.build is a placeholder module.\n"
