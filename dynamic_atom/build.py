# Placeholder build module for dynamic_atom.
#
...
# implementation when dynamic_atom.build is ready to produce build artefacts.
...
def build(*_args: Any, **_kwargs: Any) -> Mapping[str, Any]:
    """Construct build artefacts for dynamic_atom.

    Replace this stub with logic that returns serialisable data required by
    the Dynamic CLI.
    """
    raise NotImplementedError(
        "dynamic_atom.build is not implemented yet."
    )


def main() -> int:
    """Entry point for "python -m dynamic_atom.build"."""
    message = (
        "dynamic_atom.build is a placeholder module.\n"
