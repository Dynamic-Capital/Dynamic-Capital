# Placeholder build module for dynamic_tag.
#
...
# implementation when dynamic_tag.build is ready to produce build artefacts.
...
def build(*_args: Any, **_kwargs: Any) -> Mapping[str, Any]:
    """Construct build artefacts for dynamic_tag.

    Replace this stub with logic that returns serialisable data required by
    the Dynamic CLI.
    """
    raise NotImplementedError(
        "dynamic_tag.build is not implemented yet."
    )
...
def main() -> int:
    ...
    message = (
        "dynamic_tag.build is a placeholder module.\n"
