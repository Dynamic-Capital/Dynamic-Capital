...
def run(args: list[str]) -> int:
    ...
    parser.add_argument(
        ...
        default="AA+",
        help=(
            "Fine-tuning continues until the comprehensive grade outranks this letter. "
            "Use 'none' to disable the grade target."
        ),
    )
    parser.add_argument(
        "--no-fine-tune",
    ...
    target_letter = (
        None if parsed.target_letter.lower() == "none" else parsed.target_letter
    )
