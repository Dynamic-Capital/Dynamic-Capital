# Placeholder build module for dynamic_cdn.
#
...
# implementation when dynamic_cdn.build is ready to produce build artefacts.
...
def build(*_args: Any, **_kwargs: Any) -> Mapping[str, Any]:
    """Construct build artefacts for dynamic_cdn.

    Replace this stub with logic that returns serialisable data required by
    the Dynamic CLI.
    """
    raise NotImplementedError(
        "dynamic_cdn.build is not implemented yet."
    )


def main() -> int:
    """Entry point for "python -m dynamic_cdn.build"."""
    message = (
        "dynamic_cdn.build is a placeholder module.\n"
