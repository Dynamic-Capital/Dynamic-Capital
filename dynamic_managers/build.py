# Placeholder build module for dynamic_managers.
#
...
# implementation when dynamic_managers.build is ready to produce build artefacts.
...
def build(*_args: Any, **_kwargs: Any) -> Mapping[str, Any]:
    """Construct build artefacts for dynamic_managers.

    Replace this stub with logic that returns serialisable data required by
    the Dynamic CLI.
    """
    raise NotImplementedError(
        "dynamic_managers.build is not implemented yet."
    )


def main() -> int:
    """Entry point for "python -m dynamic_managers.build"."""
    message = (
        "dynamic_managers.build is a placeholder module.\n"
