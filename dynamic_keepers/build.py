# Placeholder build module for dynamic_keepers.
#
...
# implementation when dynamic_keepers.build is ready to produce build artefacts.
...
def build(*_args: Any, **_kwargs: Any) -> Mapping[str, Any]:
    """Construct build artefacts for dynamic_keepers.

    Replace this stub with logic that returns serialisable data required by
    the Dynamic CLI.
    """
    raise NotImplementedError(
        "dynamic_keepers.build is not implemented yet."
    )
...
def main() -> int:
    ...
    message = (
        "dynamic_keepers.build is a placeholder module.\n"
