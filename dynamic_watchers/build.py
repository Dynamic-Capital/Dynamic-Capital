# Placeholder build module for dynamic_watchers.
#
...
# implementation when dynamic_watchers.build is ready to produce build artefacts.
...
def build(*_args: Any, **_kwargs: Any) -> Mapping[str, Any]:
    """Construct build artefacts for dynamic_watchers.

    Replace this stub with logic that returns serialisable data required by
    the Dynamic CLI.
    """
    raise NotImplementedError(
        "dynamic_watchers.build is not implemented yet."
    )


def main() -> int:
    """Entry point for "python -m dynamic_watchers.build"."""
    message = (
        "dynamic_watchers.build is a placeholder module.\n"
