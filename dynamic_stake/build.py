# Placeholder build module for dynamic_stake.
#
...
# implementation when dynamic_stake.build is ready to produce build artefacts.
...
def build(*_args: Any, **_kwargs: Any) -> Mapping[str, Any]:
    """Construct build artefacts for dynamic_stake.

    Replace this stub with logic that returns serialisable data required by
    the Dynamic CLI.
    """
    raise NotImplementedError(
        "dynamic_stake.build is not implemented yet."
    )


def main() -> int:
    """Entry point for "python -m dynamic_stake.build"."""
    message = (
        "dynamic_stake.build is a placeholder module.\n"
