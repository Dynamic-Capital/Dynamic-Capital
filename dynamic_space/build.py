# Placeholder build module for dynamic_space.
#
...
# implementation when dynamic_space.build is ready to produce build artefacts.
...
def build(*_args: Any, **_kwargs: Any) -> Mapping[str, Any]:
    """Construct build artefacts for dynamic_space.

    Replace this stub with logic that returns serialisable data required by
    the Dynamic CLI.
    """
    raise NotImplementedError(
        "dynamic_space.build is not implemented yet."
    )


def main() -> int:
    """Entry point for "python -m dynamic_space.build"."""
    message = (
        "dynamic_space.build is a placeholder module.\n"
