# Placeholder build module for dynamic_project.
#
...
# implementation when dynamic_project.build is ready to produce build artefacts.
...
def build(*_args: Any, **_kwargs: Any) -> Mapping[str, Any]:
    """Construct build artefacts for dynamic_project.

    Replace this stub with logic that returns serialisable data required by
    the Dynamic CLI.
    """
    raise NotImplementedError(
        "dynamic_project.build is not implemented yet."
    )
...
def main() -> int:
    ...
    message = (
        "dynamic_project.build is a placeholder module.\n"
