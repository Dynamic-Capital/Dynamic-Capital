# Placeholder build module for dynamic_index.
#
...
# implementation when dynamic_index.build is ready to produce build artefacts.
...
def build(*_args: Any, **_kwargs: Any) -> Mapping[str, Any]:
    """Construct build artefacts for dynamic_index.

    Replace this stub with logic that returns serialisable data required by
    the Dynamic CLI.
    """
    raise NotImplementedError(
        "dynamic_index.build is not implemented yet."
    )
...
def main() -> int:
    ...
    message = (
        "dynamic_index.build is a placeholder module.\n"
