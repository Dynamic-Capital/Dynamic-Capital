# Placeholder build module for dynamic_candles.
#
...
# implementation when dynamic_candles.build is ready to produce build artefacts.
...
def build(*_args: Any, **_kwargs: Any) -> Mapping[str, Any]:
    """Construct build artefacts for dynamic_candles.

    Replace this stub with logic that returns serialisable data required by
    the Dynamic CLI.
    """
    raise NotImplementedError(
        "dynamic_candles.build is not implemented yet."
    )


def main() -> int:
    """Entry point for "python -m dynamic_candles.build"."""
    message = (
        "dynamic_candles.build is a placeholder module.\n"
