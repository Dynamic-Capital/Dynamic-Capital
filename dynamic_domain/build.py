# Placeholder build module for dynamic_domain.
#
...
# implementation when dynamic_domain.build is ready to produce build artefacts.
...
def build(*_args: Any, **_kwargs: Any) -> Mapping[str, Any]:
    """Construct build artefacts for dynamic_domain.

    Replace this stub with logic that returns serialisable data required by
    the Dynamic CLI.
    """
    raise NotImplementedError(
        "dynamic_domain.build is not implemented yet."
    )


def main() -> int:
    """Entry point for "python -m dynamic_domain.build"."""
    message = (
        "dynamic_domain.build is a placeholder module.\n"
