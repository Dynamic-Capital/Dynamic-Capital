# Placeholder build module for dynamic_wave.
#
...
# implementation when dynamic_wave.build is ready to produce build artefacts.
...
def build(*_args: Any, **_kwargs: Any) -> Mapping[str, Any]:
    """Construct build artefacts for dynamic_wave.

    Replace this stub with logic that returns serialisable data required by
    the Dynamic CLI.
    """
    raise NotImplementedError(
        "dynamic_wave.build is not implemented yet."
    )
...
def main() -> int:
    ...
    message = (
        "dynamic_wave.build is a placeholder module.\n"
