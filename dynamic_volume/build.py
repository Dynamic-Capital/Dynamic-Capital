# Placeholder build module for dynamic_volume.
#
...
# implementation when dynamic_volume.build is ready to produce build artefacts.
...
def build(*_args: Any, **_kwargs: Any) -> Mapping[str, Any]:
    """Construct build artefacts for dynamic_volume.

    Replace this stub with logic that returns serialisable data required by
    the Dynamic CLI.
    """
    raise NotImplementedError(
        "dynamic_volume.build is not implemented yet."
    )


def main() -> int:
    """Entry point for "python -m dynamic_volume.build"."""
    message = (
        "dynamic_volume.build is a placeholder module.\n"
