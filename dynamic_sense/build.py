# Placeholder build module for dynamic_sense.
#
...
# implementation when dynamic_sense.build is ready to produce build artefacts.
...
def build(*_args: Any, **_kwargs: Any) -> Mapping[str, Any]:
    """Construct build artefacts for dynamic_sense.

    Replace this stub with logic that returns serialisable data required by
    the Dynamic CLI.
    """
    raise NotImplementedError(
        "dynamic_sense.build is not implemented yet."
    )


def main() -> int:
    """Entry point for "python -m dynamic_sense.build"."""
    message = (
        "dynamic_sense.build is a placeholder module.\n"
