# Placeholder build module for dynamic_effect.
#
...
# implementation when dynamic_effect.build is ready to produce build artefacts.
...
def build(*_args: Any, **_kwargs: Any) -> Mapping[str, Any]:
    """Construct build artefacts for dynamic_effect.

    Replace this stub with logic that returns serialisable data required by
    the Dynamic CLI.
    """
    raise NotImplementedError(
        "dynamic_effect.build is not implemented yet."
    )


def main() -> int:
    """Entry point for "python -m dynamic_effect.build"."""
    message = (
        "dynamic_effect.build is a placeholder module.\n"
