# Placeholder build module for dynamic_proof.
#
...
# implementation when dynamic_proof.build is ready to produce build artefacts.
...
def build(*_args: Any, **_kwargs: Any) -> Mapping[str, Any]:
    """Construct build artefacts for dynamic_proof.

    Replace this stub with logic that returns serialisable data required by
    the Dynamic CLI.
    """
    raise NotImplementedError(
        "dynamic_proof.build is not implemented yet."
    )


def main() -> int:
    """Entry point for "python -m dynamic_proof.build"."""
    message = (
        "dynamic_proof.build is a placeholder module.\n"
